...

        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    {
                        // If a duplicate candidate is found, update its details
                        ...
                        existingCandidate.SelectedOptionTimestamps += candidate.SelectedOptionTimestamps;
                        existingCandidate.SelectedOptions += candidate.SelectedOptions;
                    ...
                    {
                        // If no existing candidate is found, add the new candidate
